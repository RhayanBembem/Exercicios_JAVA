...
public class Sistema {
	...
	public static void main(String[] args) throws IOException{
		...
		do {
			...
			System.out.println("Insira a opção necess�ria: ");
			opcao = ler.nextInt();
			...
			if (opcao == 1) {
				...
				System.out.printf("Insira a quantidade de produto: ");
				quantidade = ler.nextDouble();
				produto.setQuantidade(quantidade);
				
				System.out.println("Esse produto possui uma categoria (S/N) ? ");
				...
				System.out.printf("\n Insira o novo nome que o produto reber�: ");
				nome = ler.next();
				System.out.printf("\n Insira o novo preço do produto: ");
				preco = ler.nextDouble();
				System.out.printf("\n Insira a nova quantidade de produtos: ");
				quantidade = ler.nextDouble();
